...
Na v2.2.10, a mesma separação foi aplicada ao relatório `Valor do estoque`. O identificador estável é priorizado e os fallbacks posicionais refletem a ausência de WMS no perfil HORUS.
